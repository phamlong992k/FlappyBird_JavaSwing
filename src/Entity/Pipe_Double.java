...
public class Pipe_Double {
    ...
    public Pipe_Double(Color color,int width,int HEIGHT,int WIDTH, Random r) {
        
        int heightUp=r.nextInt((HEIGHT_MAX-HEIGHT_MIN)+1)+HEIGHT_MIN;
        
        up=new Pipe(color,WIDTH,0, width,heightUp);
        ...
        down= new Pipe(color,WIDTH,startHeightDown, width,900);
